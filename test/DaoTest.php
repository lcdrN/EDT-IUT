...
/* * * * */
/* Fonction GetTailleRowspan*/
    /* Scenario nominal*/
        public function testGetTailleRowspanNominal0(){
            $dao = new Dao();
            $cours = new Cours();
            $cours->setDateDebut("1441605600");
            $cours->setDateFin("1441610400");
            $groupe = new Groupe();
            $groupe->setNumero( "INFO 2 Groupe 1");
            $cours->setGroupe($groupe);
            $oracle = 1;
            $this->assertEquals($oracle, $dao->getTailleRowspan($cours));
        }
        
       public function testGetTailleRowspanNominal1(){
            $dao = new Dao();
            $cours = new Cours();
            $cours->setDateDebut("1443166200");
            $cours->setDateFin("1443171000");
            $groupe = new Groupe();
